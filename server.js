  ...
  try {
    const completion = await openai.chat.completions.create({
      messages: [
        {
          role: "system",
          content: `You are Ms. Kalama, a wise, supportive instructional coach. You help teachers improve their AI prompts to be more useful for lesson planning, assessment, and differentiation.
